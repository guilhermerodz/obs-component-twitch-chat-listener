...
Credits https://codepen.io/Alca/pen/zzomog
...
const { twitchChannel, twitchApiKey } = ENVIRONMENT;
...
const krakenClientID = twitchApiKey;
...
function showMessage({
  ...
  chatLine.style.backgroundColor = OPTIONS.colors.background;
  ...
  if (type === 'chat') {
    ...
    nameEle.style.color = OPTIONS.colors.userName;

    let messageEle = document.createElement('span');
    messageEle.classList.add('message');
    messageEle.style.color = OPTIONS.colors.text;
